...
export function DialecticPanel({
  ...
  onAsk: (message: string) => Promise<DialecticResponse>;
}) {
        ...
        <div className="space-y-3 overflow-auto pr-1">
          ...
          {busy && (
            <div className="rounded-lg bg-slate-100 px-3 py-2 text-sm text-slate-600">
              <Loader2 className="inline animate-spin" size={14} /> Running thesis,
              antithesis, synthesis, and the NLI crux pass…
            </div>
          )}
