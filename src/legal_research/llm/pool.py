...
from .base import LLMClient, is_local_endpoint
...
#: Kept as an alias: this module's callers import it by this name, and the rule
#: now lives in llm/base.py because it decides which fields a request carries.
